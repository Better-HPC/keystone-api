"""Unit tests for the `send_past_expiration_notice` function."""
...
from apps.notifications.tasks.past_expirations import send_past_expiration_notice


@patch("apps.notifications.tasks.past_expirations.send_notification_template")
class SendPastExpirationNoticeMethod(TestCase):
    """Test the sending of "past expiration" notifications."""
