...
from rest_framework.permissions import IsAdminUser as IsStaff, IsAuthenticated
...
class TeamViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [IsAuthenticated, IsStaff | TeamRBAC]
...
class MembershipViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [IsAuthenticated, IsStaff | MembershipPermissions]
